...
const allergeniPiatti = {
  ...
  "Trancio Pizza Margherita": ["Glutine", "Lattosio"],
  "Trancio Pizza Farcita": ["Glutine", "Lattosio"],
  "Toast": ["Glutine", "Lattosio"],
  "Focaccia": ["Glutine", "Lattosio"],
  "Focaccia Patanegra": ["Glutine"],
  ...
  "Gnocchi Pesto": ["Glutine", "Lattosio", "Crostacei", "Frutta a guscio"],
  "Spaghetti Astice": ["Glutine", "Crostacei"],
  "Ravioli Artigianali alla Gricia": ["Glutine", "Uova", "Lattosio"],
  "Tagliata di Manzo": ["Lattosio"],
  "Tataki di Tonno": ["Pesce", "Sesamo", "Soia"],
  ...
  "Lobster Roll": ["Glutine", "Crostacei", "Uova", "Sedano"],
